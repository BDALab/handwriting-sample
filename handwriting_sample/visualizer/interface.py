...
class HandwritingSampleVisualizer(HandwritingDataBase):
    ...
    def _plot_strokes(self,
        ...
        # Get strokes
        stroke_data = sample.get_strokes(on_surface_only=True,
        ...
        for stroke in stroke_data:
            self._plot_task(stroke,
                            ...
                            y_label=y_label,
                            ax=axis,
                            in_air_movement=in_air_movement,
...
# def plot_all_modalities(data, x_label=None, y_label=None, save_as=None):
#     """
#     Plot separate line plots with all modalities of data
#
#     :param data: input data loaded from SVC
#     :param x_label: label of X axis
#     :param y_label: label of Y axis
#     :param save_as: setup save location if you want to save a file
#     """
...
#         # Set labels
#         x_label = col if not x_label else x_label
#         y_label = "value []" if not y_label else y_label
#
#         # Plot lines
#         plot_line(data[col], x_label, y_label, save_as=save_as)
#
#
